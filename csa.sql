...
CREATE TABLE `element_constitutif` (
  ...
  `no_enseignant` int(11) NOT NULL,
  `unite_enseignement_ueid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `avenant`
  ...
  ADD KEY `FKk5l2r5og9n2jfudl4n92tkyer` (`no_etudiant_nat`,`annee_pro`);
...
ALTER TABLE `element_constitutif`
  ...
  ADD KEY `FK6dd1o79vmurfdq1fkyy7js8gm` (`unite_enseignement_ueid`);
...
--
-- Indexes for table `entreprise_jn`
--
...
ALTER TABLE `user_role`
  ...
  ADD KEY `FK8c2jfhwogxxyppgwpdpbdoyun` (`no_contact_ili`),
  ADD KEY `FKpfgsmwli3dv4wkt92h9p3ksjd` (`no_enseignant`),
  ADD KEY `FKkls1mnm2jbh7v359x3j9ieks9` (`no_etudiant_nat`),
...
--
ALTER TABLE `avenant`
  ADD CONSTRAINT `FKk5l2r5og9n2jfudl4n92tkyer` FOREIGN KEY (`no_etudiant_nat`,`annee_pro`) REFERENCES `stage` (`ANNEE_PRO`, `NO_ETUDIANT_NAT`);
...
--
ALTER TABLE `element_constitutif`
  ADD CONSTRAINT `FK6dd1o79vmurfdq1fkyy7js8gm` FOREIGN KEY (`unite_enseignement_ueid`) REFERENCES `unite_enseignement` (`ueid`),
...
--
ALTER TABLE `user_role`
  ADD CONSTRAINT `FK2aam9nt2tv8vcfymi3jo9c314` FOREIGN KEY (`id_role`) REFERENCES `role` (`id_role`),
  ADD CONSTRAINT `FK8c2jfhwogxxyppgwpdpbdoyun` FOREIGN KEY (`no_contact_ili`) REFERENCES `employe` (`no_contact_ili`),
  ADD CONSTRAINT `FKfhxaael2m459kbk8lv8smr5iv` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `FKkls1mnm2jbh7v359x3j9ieks9` FOREIGN KEY (`no_etudiant_nat`) REFERENCES `etudiant` (`no_etudiant_nat`),
  ADD CONSTRAINT `FKpfgsmwli3dv4wkt92h9p3ksjd` FOREIGN KEY (`no_enseignant`) REFERENCES `enseignant` (`no_enseignant`);
